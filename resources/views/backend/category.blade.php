            ...
            <section class="col-xs-12">
              <div class="box box-solid">
                <div class="box-header bg-gray-light">
                  <div class="box-title">
                    <a href="#add" data-toggle="modal" data-target="#modal-category" data-action="add" class="btn bg-maroon"><i class="fa fa-plus"></i> {{ ucwords(trans('livepos.category.add')) }}</a>
                  </div>
                ...
                <div class="box-footer">
                  <table class="table table-hover" id="categories-table">
                      <thead>
                          <tr>
                              <th class="bg-navy">{{ trans('livepos.category.name') }}</th>
                              <th class="bg-navy"></th>
                          </tr>
                      </thead>
                  </table>
          ...
          <form class="form-horizontal" method="POST">
            <div class="modal-body">
              ...
              <div class="form-group">
                <label for="category" class="col-sm-2 control-label">{{ trans('livepos.category.name') }}</label>
                <div class="col-sm-10">
...
$(function() {
    ...
    var modal = $('#modal-category'), modalDelete = $('#modal-delete'), form = modal.find('form'), formDelete = modalDelete.find('form');
